define([], function() {
    ...
    var config = {
        ...
        welcomeDialogContent: "<div style='font-size:14px;'><p class='launch-dialog-content'><span class='introTextTitle'>The Global Platform</span> is designed to help indigenous peoples and communities protect their lands. To achieve this goal, the tool must be current and comprehensive. Please help us improve this tool by sharing your impressions and your information on collective lands (<a class='introTextTitle' href='contact.html'>Contact Us</a>).</p></div>"
    };
