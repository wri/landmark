define(['institutions/main/config', 'components/institutionsAccordion'], function(institutionsConfig, InstitutionsAccordion) {
    'use strict';
    ...
    var AppController = {
        ...
        renderComponents: function() {
            ...
            var newAccord = new InstitutionsAccordion(null, "institutionsAccordion");
        },
