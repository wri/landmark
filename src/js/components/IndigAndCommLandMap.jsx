    	...
    	return (
            ...
            <div className={'national-layer-selection-label' + (this.props.openTab ? '': ' hidden')}>
              ...
              <div className='national-layer-selection-label'>
                <div className='community-layer-type-label' id='communityLands'><span className='parent-layer-checked-true comm-land-parent' onClick={this.props.parentClicked}></span>Community Lands - traditional or customary rights<span id='community-lands-help' className='parent-layer-help' onClick={this.props.showHelp}></span></div>
