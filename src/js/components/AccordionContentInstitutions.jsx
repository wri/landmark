          ...
          <div className='institutions-Accordion'>
            ...
            <div style={{'display': (this.state.activePanel === '1' ? 'block' : 'none')}}>
              ...
              <table id='institutions-developers'>
                <tr><td><img src='css/images/wriLogo.png'></img><p><a className='developers-website' href='http://www.wri.org'>{institutionsConfig.leadDevRow2a}</a></p></td><td><p><strong>{institutionsConfig.leadDevRow2b}</strong></p>{institutionsConfig.leadDevRow2c}{institutionsConfig.leadDevRow2d}<p><strong>{institutionsConfig.leadDevRow2e}</strong>{institutionsConfig.leadDevRow2f}</p><p><strong>{institutionsConfig.leadDevRow2g}</strong>{institutionsConfig.leadDevRow2h}</p><p><strong>{institutionsConfig.leadDevRow2i}</strong>{institutionsConfig.leadDevRow2j}</p></td></tr>
                <tr><td><img src='css/images/bienLogo.png'></img><p><a className='developers-website' href='www.ibcperu.org/'>{institutionsConfig.leadDevRow1a}</a></p></td><td><p><strong>{institutionsConfig.leadDevRow1b}</strong></p>{institutionsConfig.leadDevRow1c}{institutionsConfig.leadDevRow1d}<p><strong>{institutionsConfig.leadDevRow1e}</strong>{institutionsConfig.leadDevRow1f}</p><p><strong>{institutionsConfig.leadDevRow1g}</strong>{institutionsConfig.leadDevRow1h}</p><p><strong>{institutionsConfig.leadDevRow1i}</strong>{institutionsConfig.leadDevRow1j}</p></td></tr>
                <tr><td><img src='css/images/waiptIcon.png'></img><p><a className='developers-website' href='www.iheal.univ-paris3.fr/en/recherche/waipt-project'>{institutionsConfig.leadDevRow3a}</a></p></td><td><p><strong>{institutionsConfig.leadDevRow3b}</strong></p>{institutionsConfig.leadDevRow3c}{institutionsConfig.leadDevRow3d}<p><strong>{institutionsConfig.leadDevRow3e}</strong>{institutionsConfig.leadDevRow3f}</p><p><strong>{institutionsConfig.leadDevRow3g}</strong>{institutionsConfig.leadDevRow3h}</p><p><strong>{institutionsConfig.leadDevRow3i}</strong>{institutionsConfig.leadDevRow3j}</p></td></tr>
              </table>
            </div>
            ...
            <div style={{'display': (this.state.activePanel === '2' ? 'block' : 'none')}}>
              ...
              <table id='institutions-steering-group'>
                <tr><td><img src='css/images/amanLogo.png'></img><p><a className='developers-website' href='www.aman.or.id/'>{institutionsConfig.steeringGroup2a}</a></p></td><td><p><strong>{institutionsConfig.steeringGroup2b}</strong></p>{institutionsConfig.steeringGroup2c}{institutionsConfig.steeringGroup2d}<p><strong>{institutionsConfig.steeringGroup2e}</strong>{institutionsConfig.steeringGroup2f}</p><p><strong>{institutionsConfig.steeringGroup2g}</strong>{institutionsConfig.steeringGroup2h}</p><p><strong>{institutionsConfig.steeringGroup2i}</strong>{institutionsConfig.steeringGroup2j}</p></td></tr>
                <tr><td><img src='css/images/forestPeoplesLogo.gif'></img><p><a className='developers-website' href='www.forestpeoples.org/'>{institutionsConfig.steeringGroup3a}</a></p></td><td><p><strong>{institutionsConfig.steeringGroup3b}</strong></p>{institutionsConfig.steeringGroup3c}{institutionsConfig.steeringGroup3d}<p><strong>{institutionsConfig.steeringGroup3e}</strong>{institutionsConfig.steeringGroup3f}</p><p><strong>{institutionsConfig.steeringGroup3g}</strong>{institutionsConfig.steeringGroup3h}</p><p><strong>{institutionsConfig.steeringGroup3i}</strong>{institutionsConfig.steeringGroup3j}</p></td></tr>
                <tr><td><img src='css/images/fesLogo.gif'></img><p><a className='developers-website' href='fes.org.in/'>{institutionsConfig.steeringGroup4a}</a></p></td><td><p><strong>{institutionsConfig.steeringGroup4b}</strong></p>{institutionsConfig.steeringGroup4c}{institutionsConfig.steeringGroup4d}<p><strong>{institutionsConfig.steeringGroup4e}</strong>{institutionsConfig.steeringGroup3f}</p><p><strong>{institutionsConfig.steeringGroup4g}</strong>{institutionsConfig.steeringGroup4h}</p><p><strong>{institutionsConfig.steeringGroup4i}</strong>{institutionsConfig.steeringGroup4j}</p></td></tr>

                <tr><td><img src='css/images/bienLogo.png'></img><p><a className='developers-website' href='www.ibcperu.org/'>{institutionsConfig.steeringGroup5a}</a></p></td><td><p><strong>{institutionsConfig.steeringGroup5b}</strong></p>{institutionsConfig.steeringGroup5c}{institutionsConfig.steeringGroup5d}<p><strong>{institutionsConfig.steeringGroup5e}</strong>{institutionsConfig.steeringGroup5f}</p><p><strong>{institutionsConfig.steeringGroup5g}</strong>{institutionsConfig.steeringGroup5h}</p><p><strong>{institutionsConfig.steeringGroup5i}</strong>{institutionsConfig.steeringGroup5j}</p></td></tr>
                <tr><td><img src='css/images/landCOLogo.png'></img><p><a className='developers-website' href='www.landcoalition.org/'>{institutionsConfig.steeringGroup6a}</a></p></td><td><p><strong>{institutionsConfig.steeringGroup6b}</strong></p>{institutionsConfig.steeringGroup6c}{institutionsConfig.steeringGroup6d}<p><strong>{institutionsConfig.steeringGroup6e}</strong>{institutionsConfig.steeringGroup6f}</p><p><strong>{institutionsConfig.steeringGroup6g}</strong>{institutionsConfig.steeringGroup6h}</p><p><strong>{institutionsConfig.steeringGroup6i}</strong>{institutionsConfig.steeringGroup6j}</p></td></tr>

                <tr><td><p>{institutionsConfig.steeringGroup7aa}</p><p>{institutionsConfig.steeringGroup7a}</p></td><td><p><strong>{institutionsConfig.steeringGroup7b}</strong></p>{institutionsConfig.steeringGroup7c}{institutionsConfig.steeringGroup7d}<p><strong>{institutionsConfig.steeringGroup7e}</strong>{institutionsConfig.steeringGroup7f}</p><p><strong>{institutionsConfig.steeringGroup7g}</strong>{institutionsConfig.steeringGroup7h}</p></td></tr>

                <tr><td><img src='css/images/pafidLogo.png'></img><p><a className='developers-website' href='www.pafid.org.ph/'>{institutionsConfig.steeringGroup8a}</a></p></td><td><p><strong>{institutionsConfig.steeringGroup8b}</strong></p>{institutionsConfig.steeringGroup8c}{institutionsConfig.steeringGroup8d}<p><strong>{institutionsConfig.steeringGroup8e}</strong>{institutionsConfig.steeringGroup8f}</p><p><strong>{institutionsConfig.steeringGroup8g}</strong>{institutionsConfig.steeringGroup8h}</p><p><strong>{institutionsConfig.steeringGroup8i}</strong>{institutionsConfig.steeringGroup8j}</p></td></tr>
                <tr><td><img src='css/images/rainUKLogo.png'></img><p><a className='developers-website' href='www.rainforestfoundationuk.org/'>{institutionsConfig.steeringGroup9a}</a></p></td><td><p><strong>{institutionsConfig.steeringGroup9b}</strong></p>{institutionsConfig.steeringGroup9c}{institutionsConfig.steeringGroup9d}<p><strong>{institutionsConfig.steeringGroup9e}</strong>{institutionsConfig.steeringGroup9f}</p><p><strong>{institutionsConfig.steeringGroup9g}</strong>{institutionsConfig.steeringGroup9h}</p><p><strong>{institutionsConfig.steeringGroup9i}</strong>{institutionsConfig.steeringGroup9j}</p></td></tr>
                <tr><td><img src='css/images/rightsLogo.jpg'></img><p><a className='developers-website' href='www.rightsandresources.org/'>{institutionsConfig.steeringGroup10a}</a></p></td><td><p><strong>{institutionsConfig.steeringGroup10b}</strong></p>{institutionsConfig.steeringGroup10c}{institutionsConfig.steeringGroup10d}<p><strong>{institutionsConfig.steeringGroup10e}</strong>{institutionsConfig.steeringGroup10f}</p><p><strong>{institutionsConfig.steeringGroup10g}</strong>{institutionsConfig.steeringGroup10h}</p><p><strong>{institutionsConfig.steeringGroup10i}</strong>{institutionsConfig.steeringGroup10j}</p></td></tr>
                <tr><td><img src='css/images/waiptIcon.png'></img><p><a className='developers-website' href='www.iheal.univ-paris3.fr/en/recherche/waipt-project'>{institutionsConfig.steeringGroup11a}</a></p></td><td><p><strong>{institutionsConfig.steeringGroup11b}</strong></p>{institutionsConfig.steeringGroup11c}{institutionsConfig.steeringGroup11d}<p><strong>{institutionsConfig.steeringGroup11e}</strong>{institutionsConfig.steeringGroup11f}</p><p><strong>{institutionsConfig.steeringGroup11g}</strong>{institutionsConfig.steeringGroup11h}</p><p><strong>{institutionsConfig.steeringGroup11i}</strong>{institutionsConfig.steeringGroup11j}</p></td></tr>
                <tr><td><img src='css/images/wriLogo.png'></img><p><a className='developers-website' href='www.wri.org/'>{institutionsConfig.steeringGroup12a}</a></p></td><td><p><strong>{institutionsConfig.steeringGroup12b}</strong></p>{institutionsConfig.steeringGroup12c}{institutionsConfig.steeringGroup12d}<p><strong>{institutionsConfig.steeringGroup12e}</strong>{institutionsConfig.steeringGroup12f}</p><p><strong>{institutionsConfig.steeringGroup12g}</strong>{institutionsConfig.steeringGroup12h}</p><p><strong>{institutionsConfig.steeringGroup12i}</strong>{institutionsConfig.steeringGroup12j}</p></td></tr>
