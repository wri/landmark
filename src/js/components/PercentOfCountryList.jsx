    ...
    render: function () {
    	...
    	return (
				<div className='percent-indigenous-layer-list'>
					<LayerList class='percent-indigenous-tree' activeTab={this.props.activeTab} data={MapConfig.percentIndigenousLayersCombined} change={this.changePercentIndigenousLayer} layerActive={this.state.active} />
					<PercentLegend legendObject={legendObject} />
				</div>
    	);
    }
    /* jshint ignore:end */
